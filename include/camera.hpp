...
namespace my_gl {
    ...
    class Camera {
    public:
        my_gl::math::Vec3<float> camera_pos          { 0.0f, 0.0f, 3.0f };
        my_gl::math::Vec3<float> camera_front        { 0.0f, 0.0f, -1.0f };
        my_gl::math::Vec3<float> camera_up           { 0.0f, 1.0f, 0.0f };
        my_gl::math::Vec3<float> camera_right        { 1.0f, 0.0f, 0.0f };
        my_gl::math::Vec3<float> world_up            { 0.0f, 1.0f, 0.0f };
        ...
        Camera() = default;
        Camera(my_gl::math::Vec3<float>&& pos, my_gl::math::Vec3<float>&& dir, my_gl::math::Vec3<float>&& up);
        Camera(const my_gl::math::Vec3<float>& pos, const my_gl::math::Vec3<float>& dir, const my_gl::math::Vec3<float>& up);

        my_gl::math::Matrix44<float>    get_view_mat();
