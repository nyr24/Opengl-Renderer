...
public:
    ...
    void                                calc_model_mat_frame(Duration_sec delta_time);
    ...
    void                                draw() const;
    void                                render(const math::Matrix44<float>& view_mat, const math::Matrix44<float>& view_proj_mat, Duration_sec delta_time, float time_0to1);

    std::span<TransformData>        _transform_data;
    void* const                     _custom_obj_state;
    FrameTransform<float>* const    _movement;
